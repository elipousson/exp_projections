...
ledger_summary <- ledger %>%
  select(label = `Ledger Summary`, !!sym(paste0("FY", params$fy, " Budget")), !!sym(internal$col.proj), !!sym(internal$col.surdef)) %>%
  arrange(label)
...
format_plot(
  type = "bar_group",
  set_scale = "m",
  bar_anno_col = internal$col.surdef,
  margin_t = 50, margin_b = 50,
  bar_anno_word_positive = " surplus",
  bar_anno_word_negative = " deficit"
  ) %>%
