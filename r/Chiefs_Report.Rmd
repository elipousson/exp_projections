...
ledger <- compiled %>%
  select(`Spend Category`, !!sym(paste0("FY", params$fy-1, " Actuals")), `YTD Actuals`,
...
ledger %>%
  select(label = `Ledger Summary`, !!sym(paste0("FY", params$fy, " Budget")), !!sym(paste0("Q", params$qtr, " Projection")), !!sym(paste0("Q", params$qtr, " Surplus/Deficit"))) %>%
  arrange(label) %>%
  format_plot(
