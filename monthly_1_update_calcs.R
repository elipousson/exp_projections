...
object <- expend %>%
  distinct(
    `Agency ID`, `Agency Name`, `Fund ID`, `Fund Name`,
...
# openxlsx formatting
style.cellbg <- openxlsx::createStyle(
